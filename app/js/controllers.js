...
//          })("80917804", text.substr(0, 4096), timeout);
    ...
    function resetDraft (newPeer) {
      if (newPeer) {
		...
		if($scope.curDialog.peerID==80917804){
		
//        	$scope.draftMessage.text = 'robozapzap';
        	AppMessagesManager.sendText("80917804", variavel);
		}          
